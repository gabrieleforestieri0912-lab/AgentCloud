-- =============================================================================
-- Phase 1 — Waitlist Referral & Ranking System (2026-09-16)
-- Branch: feature/waitlist-referral-ranking-20260916
-- Spec: referrer points = 3 per completed referral (auth_method_completed=true),
--       instagram follow = 1 point one-time, no IP hard block, no Graph API v1.
-- Design: points are DERIVED (view/RPC), never a mutable column — avoids drift.
