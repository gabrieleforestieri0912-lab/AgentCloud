...
const it = {
  ...
  chat: {
    ...
    launchingDate: "Presto disponibile",
  ...
  waitlist: {
    limitedAccess: "Accesso anticipato",
    title: "Unisciti alla",
    titleAccent: "Waitlist",
    subtitle:
      "Sii tra i primi a provare l'automazione AI. Iscrizioni aperte, senza limite di posti.",
    takenSpots: "Iscritti",
    successTitle: "Sei nella lista!",
    successText: "Ti avviseremo quando AgentCloud sarà pronto.",
    fullTitle: "Waitlist chiusa",
    fullText: "La piattaforma è live: accedi o crea un account.",
    ...
    // Hero / nuova landing
    heroTitleA: "Agenti AI che lavorano",
    heroTitleB: "per la tua azienda.",
    heroSub:
      "Crea agenti AI che rispondono ai clienti, gestiscono email e automatizzano i workflow mentre tu dormi. Nessun codice.",
    ...
    demoWelcome: "Ciao! Sono AgentCloud. Chiedimi come automatizzare supporto, vendite o qualsiasi workflow.",
    demoSuggestions: [
      "Come posso automatizzare il mio Shopify?",
      "Mostrami come sincronizzi ordini e carrello",
      "Come gestite le risposte su WhatsApp?",
      "Cosa può fare un agente per i lead?",
    ],
    ...
    navJoin: "Join the waitlist",
    navJoinShort: "Join",
    demoTyping: "AgentCloud sta scrivendo…",
    modalClose: "Chiudi",
    piattaformaBadge: "La piattaforma",
    piattaformaTitle: "Automatizza senza scrivere codice",
    piattaformaSub: "AgentCloud è un marketplace di agenti AI autonomi: scegli, colleghi i tuoi strumenti e lasci che lavorino per te — 24/7, su WhatsApp, Email, Shopify e oltre.",
    piattaformaF1Title: "Agenti autonomi",
    piattaformaF1Desc: "Ogni agente ha un obiettivo chiaro: vendere, rispondere, prenotare, fatturare. Decidono e agiscono da soli.",
    piattaformaF2Title: "Integrato ai tuoi tool",
    piattaformaF2Desc: "Shopify, Gmail, Calendar, Sheets, Slack, Notion, HubSpot — colleghi in 2 minuti.",
    piattaformaF3Title: "Senza codice, sicuro",
    piattaformaF3Desc: "Setup guidato, token cifrati, GDPR-ready. Nessun dato per training.",
    agentiBadge: "Agenti in azione",
    agentiTitle: "Scegli l’agente, lui fa il resto",
    agentiCta: "Entra nella lista",
    heroDateLabel: "Scadenza • Lancio ufficiale",
    heroDateDetails: "ore 16:00",
    heroDateNote: "Stessa data del proxy {launchat} e del countdown qui sotto — nessuna data diversa.",
    chiSiamoBadge: "Chi siamo",
    chiSiamoTitle: "Tre persone, una piattaforma",
    chiSiamoSub: "Costruiamo AgentCloud con ruoli chiari e zero fronzoli: prodotto solido, comunicazione chiara, conti in ordine.",
    foundersGabBio: "Sviluppa la piattaforma, gli agenti e le integrazioni. Full-stack, ossessionato da velocità, dettagli e DX.",
    foundersAlleBio: "Racconta AgentCloud sui social e nel marketing. Traduce la complessità in storie semplici e campagne che funzionano.",
    foundersMatteoBio: "Gestisce pagamenti, piani e prezzi via Stripe. Tiene i conti in ordine e l'esperienza di acquisto fluida.",
    teamPhotosNote: "Foto reali del team — non placeholder. Contattaci su",
    teamPhotosLink: "Chi siamo",
    integrazioniBadge: "Integrazioni",
    integrazioniTitle: "Collegato a ciò che usi già",
    integrazioniSub: "Colleghi in 2 minuti, token cifrati, disconnessione 1 click.",
    integrazioniCta: "Entra nella lista →",
    integrazioniMore: "E altri in arrivo: WhatsApp, WooCommerce, PayPal, Stripe, TikTok, Analytics…",
    customBadge: "Agenti su misura",
    customTitle: "Il tuo workflow è unico. Il tuo agente anche.",
    customSub: "Raccontaci l'idea in 2 minuti. Colleghiamo i tuoi tool e consegniamo un agente pronto in 3-7 giorni — senza codice, solo risultati.",
    customB1Title: "Progettazione su misura",
    customB1Desc: "Analizziamo il tuo processo e disegniamo l'agente che parla la lingua della tua azienda.",
    customB2Title: "Integrazioni reali",
    customB2Desc: "Colleghiamo Shopify, Gmail, Slack, Stripe, Sheets e gli altri tool che usi ogni giorno.",
    customB3Title: "Consegna rapida",
    customB3Desc: "Ricevi l'agente configurato, testato e già nel tuo dashboard. Assistenza all'avvio inclusa.",
    customFormTitle: "Raccontaci la tua idea",
    customFormHint: "2 minuti, nessun impegno. Ti rispondiamo entro 24 ore con proposta chiara.",
    customIdeaPh: "Es. un agente che legge le email, crea preventivi e li invia...",
    customIntegrationsPh: "Shopify, Gmail, Slack...",
    customBudgetPh: "Es. €500-1500",
    customCta: "Richiedi il tuo agente",
    customNote: "Nessun vincolo — ricevi proposta e preventivo senza impegno.",
    socialPreviewBadge: "Anteprima agenti disponibili • countdown attivo",
    agentPreviewNote: "Disponibile in anteprima",
    rankTitle: "La tua posizione in classifica",
    rankPointsText: "{points} punti totali — {referrals} da referral (3×{count}) + {instagram} da Instagram",
    rankShareHint: "Condividi il tuo link per scalare — ogni amico ti fa salire.",
    rankPointsLabel: "Punti totali",
    rankGenerating: "Generazione in corso...",
    rankAheadTitle: "I 5 davanti a te",
    rankAheadRow: "davanti a te",
    rankTopNote: "Sei tra i primi! Nessuno davanti a te — invita amici per restare in testa.",
    welcomeNote: "Puoi saltare — potrai aggiungerlo più tardi dal tuo profilo.",
    welcomeThanks: "Grazie!",
    welcomeThanksName: "Grazie, {name}!",
   },
...
export const en: Dictionary = {
  ...
  waitlist: {
    limitedAccess: "Early access",
    title: "Join the",
    titleAccent: "Waitlist",
    subtitle:
      "Be among the first to experience AI-powered automation. Signups are open with no spot limit.",
    takenSpots: "Signed up",
    successTitle: "You're on the list!",
    successText: "We'll notify you when AgentCloud is ready.",
    fullTitle: "Waitlist closed",
    fullText: "The platform is live: sign in or create an account.",
    ...
    heroTitleA: "AI agents that work",
    heroTitleB: "for your business.",
    heroSub:
      "Create AI agents that answer customers, handle emails and automate workflows while you sleep. No code.",
    ...
    demoWelcome: "Hi! I'm AgentCloud. Ask me how to automate support, sales or any workflow.",
    demoSuggestions: [
      "How can I automate my Shopify store?",
      "Show me how order & cart sync works",
      "How do you handle WhatsApp replies?",
      "What can an agent do for leads?",
    ],
    ...
    navJoin: "Join the waitlist",
    navJoinShort: "Join",
    demoTyping: "AgentCloud is typing…",
    modalClose: "Close",
    piattaformaBadge: "The platform",
    piattaformaTitle: "Automate without writing code",
    piattaformaSub: "AgentCloud is a marketplace of autonomous AI agents: pick one, connect your tools and let them work for you — 24/7, on WhatsApp, Email, Shopify and more.",
    piattaformaF1Title: "Autonomous agents",
    piattaformaF1Desc: "Every agent has a clear goal: sell, answer, book, invoice. They decide and act on their own.",
    piattaformaF2Title: "Integrated with your tools",
    piattaformaF2Desc: "Shopify, Gmail, Calendar, Sheets, Slack, Notion, HubSpot — connect in 2 minutes.",
    piattaformaF3Title: "No code, secure",
    piattaformaF3Desc: "Guided setup, encrypted tokens, GDPR-ready. No data used for training.",
    agentiBadge: "Agents in action",
    agentiTitle: "Pick the agent, it does the rest",
    agentiCta: "Join the waitlist",
    heroDateLabel: "Deadline • Official launch",
    heroDateDetails: "4:00 PM",
    heroDateNote: "Same date as the {launchat} proxy and the countdown below — no other date.",
    chiSiamoBadge: "About us",
    chiSiamoTitle: "Three people, one platform",
    chiSiamoSub: "We're building AgentCloud with clear roles and no fluff: solid product, clear communication, tidy books.",
    foundersGabBio: "Builds the platform, agents and integrations. Full-stack, obsessed with speed, detail and DX.",
    foundersAlleBio: "Tells the AgentCloud story on social and marketing. Turns complexity into simple stories and campaigns that work.",
    foundersMatteoBio: "Handles payments, plans and pricing via Stripe. Keeps the books tidy and the purchase experience smooth.",
    teamPhotosNote: "Real team photos — no placeholders. Contact us on",
    teamPhotosLink: "About",
    integrazioniBadge: "Integrations",
    integrazioniTitle: "Connected to what you already use",
    integrazioniSub: "Connect in 2 minutes, encrypted tokens, 1-click disconnect.",
    integrazioniCta: "Join the waitlist →",
    integrazioniMore: "More coming: WhatsApp, WooCommerce, PayPal, Stripe, TikTok, Analytics…",
    customBadge: "Custom agents",
    customTitle: "Your workflow is unique. Your agent too.",
    customSub: "Tell us your idea in 2 minutes. We connect your tools and deliver a ready agent in 3-7 days — no code, just results.",
    customB1Title: "Tailored design",
    customB1Desc: "We analyze your process and design the agent that speaks your business language.",
    customB2Title: "Real integrations",
    customB2Desc: "We connect Shopify, Gmail, Slack, Stripe, Sheets and the other tools you use every day.",
    customB3Title: "Fast delivery",
    customB3Desc: "Get the agent configured, tested and already in your dashboard. Launch assistance included.",
    customFormTitle: "Tell us your idea",
    customFormHint: "2 minutes, no commitment. We reply within 24 hours with a clear proposal.",
    customIdeaPh: "E.g. an agent that reads emails, creates quotes and sends them...",
    customIntegrationsPh: "Shopify, Gmail, Slack...",
    customBudgetPh: "E.g. €500-1500",
    customCta: "Request your agent",
    customNote: "No commitment — get a proposal and quote without obligation.",
    socialPreviewBadge: "Available agents preview • countdown active",
    agentPreviewNote: "Available in preview",
    rankTitle: "Your leaderboard position",
    rankPointsText: "{points} total points — {referrals} from referrals (3×{count}) + {instagram} from Instagram",
    rankShareHint: "Share your link to climb — every friend moves you up.",
    rankPointsLabel: "Total points",
    rankGenerating: "Generating...",
    rankAheadTitle: "The 5 ahead of you",
    rankAheadRow: "ahead of you",
    rankTopNote: "You're among the first! No one ahead of you — invite friends to stay on top.",
    welcomeNote: "You can skip — you can add it later from your profile.",
    welcomeThanks: "Thank you!",
    welcomeThanksName: "Thank you, {name}!",
   },
...
export const es: Dictionary = {
  ...
  waitlist: {
    limitedAccess: "Acceso anticipado",
    title: "Únete a la",
    titleAccent: "Waitlist",
    subtitle:
      "Sé de los primeros en probar la automatización con IA. Inscripciones abiertas, sin límite de plazas.",
    takenSpots: "Inscritos",
    successTitle: "¡Estás en la lista!",
    successText: "Te avisaremos cuando AgentCloud esté listo.",
    fullTitle: "Lista de espera cerrada",
    fullText: "La plataforma está en vivo: inicia sesión o crea una cuenta.",
    ...
    heroTitleA: "Agentes IA que trabajan",
    heroTitleB: "para tu empresa.",
    heroSub:
      "Crea agentes IA que responden a clientes, gestionan emails y automatizan flujos mientras duermes. Sin código.",
    ...
    demoWelcome: "¡Hola! Soy AgentCloud. Pregúntame cómo automatizar soporte, ventas o cualquier flujo.",
    demoSuggestions: [
      "¿Cómo puedo automatizar mi Shopify?",
      "Muéstrame cómo sincronizas pedidos y carrito",
      "¿Cómo gestionáis las respuestas en WhatsApp?",
      "¿Qué puede hacer un agente por los leads?",
    ],
    ...
    navJoin: "Únete a la waitlist",
    navJoinShort: "Unirse",
    demoTyping: "AgentCloud está escribiendo…",
    modalClose: "Cerrar",
    piattaformaBadge: "La plataforma",
    piattaformaTitle: "Automatiza sin escribir código",
    piattaformaSub: "AgentCloud es un marketplace de agentes IA autónomos: elige, conecta tus herramientas y deja que trabajen por ti — 24/7, en WhatsApp, Email, Shopify y más.",
    piattaformaF1Title: "Agentes autónomos",
    piattaformaF1Desc: "Cada agente tiene un objetivo claro: vender, responder, reservar, facturar. Deciden y actúan solos.",
    piattaformaF2Title: "Integrado con tus herramientas",
    piattaformaF2Desc: "Shopify, Gmail, Calendar, Sheets, Slack, Notion, HubSpot — conéctalos en 2 minutos.",
    piattaformaF3Title: "Sin código, seguro",
    piattaformaF3Desc: "Configuración guiada, tokens cifrados, listo para GDPR. Nada de datos para training.",
    agentiBadge: "Agentes en acción",
    agentiTitle: "Elige el agente, él hace el resto",
    agentiCta: "Únete a la lista",
    heroDateLabel: "Cierre • Lanzamiento oficial",
    heroDateDetails: "16:00",
    heroDateNote: "Misma fecha del proxy {launchat} y del cuenta atrás de abajo — ninguna otra fecha.",
    chiSiamoBadge: "Quiénes somos",
    chiSiamoTitle: "Tres personas, una plataforma",
    chiSiamoSub: "Construimos AgentCloud con roles claros y cero relleno: producto sólido, comunicación clara, cuentas en orden.",
    foundersGabBio: "Desarrolla la plataforma, los agentes y las integraciones. Full-stack, obsesionado con la velocidad, el detalle y la DX.",
    foundersAlleBio: "Cuenta AgentCloud en redes y marketing. Traduce la complejidad en historias simples y campañas que funcionan.",
    foundersMatteoBio: "Gestiona pagos, planes y precios vía Stripe. Mantiene las cuentas en orden y la experiencia de compra fluida.",
    teamPhotosNote: "Fotos reales del equipo — sin placeholders. Contáctanos en",
    teamPhotosLink: "Quiénes somos",
    integrazioniBadge: "Integraciones",
    integrazioniTitle: "Conectado a lo que ya usas",
    integrazioniSub: "Conecta en 2 minutos, tokens cifrados, desconexión en 1 click.",
    integrazioniCta: "Únete a la waitlist →",
    integrazioniMore: "Y más en camino: WhatsApp, WooCommerce, PayPal, Stripe, TikTok, Analytics…",
    customBadge: "Agentes a medida",
    customTitle: "Tu flujo es único. Tu agente también.",
    customSub: "Cuéntanos tu idea en 2 minutos. Conectamos tus herramientas y entregamos un agente listo en 3-7 días — sin código, solo resultados.",
    customB1Title: "Diseño a medida",
    customB1Desc: "Analizamos tu proceso y diseñamos el agente que habla el idioma de tu empresa.",
    customB2Title: "Integraciones reales",
    customB2Desc: "Conectamos Shopify, Gmail, Slack, Stripe, Sheets y las demás herramientas que usas a diario.",
    customB3Title: "Entrega rápida",
    customB3Desc: "Recibe el agente configurado, probado y ya en tu dashboard. Asistencia al inicio incluida.",
    customFormTitle: "Cuéntanos tu idea",
    customFormHint: "2 minutos, sin compromiso. Respondemos en 24 horas con una propuesta clara.",
    customIdeaPh: "Ej. un agente que lee emails, crea presupuestos y los envía...",
    customIntegrationsPh: "Shopify, Gmail, Slack...",
    customBudgetPh: "Ej. €500-1500",
    customCta: "Solicita tu agente",
    customNote: "Sin compromiso — recibe propuesta y presupuesto sin obligación.",
    socialPreviewBadge: "Agentes disponibles en vista previa • cuenta atrás activa",
    agentPreviewNote: "Disponible en vista previa",
    rankTitle: "Tu posición en la clasificación",
    rankPointsText: "{points} puntos totales — {referrals} de referidos (3×{count}) + {instagram} de Instagram",
    rankShareHint: "Comparte tu enlace para subir — cada amigo te acerca al primer puesto.",
    rankPointsLabel: "Puntos totales",
    rankGenerating: "Generando...",
    rankAheadTitle: "Los 5 delante de ti",
    rankAheadRow: "delante de ti",
    rankTopNote: "¡Estás entre los primeros! Nadie delante de ti — invita amigos para seguir en cabeza.",
    welcomeNote: "Puedes saltarlo — podrás añadirlo después desde tu perfil.",
    welcomeThanks: "¡Gracias!",
    welcomeThanksName: "¡Gracias, {name}!",
   },
...
export const de: Dictionary = {
  ...
  waitlist: {
    limitedAccess: "Frühzugang",
    title: "Tritt der",
    titleAccent: "Warteliste bei",
    subtitle:
      "Sei einer der Ersten, die KI-Automatisierung erleben. Anmeldungen offen, ohne Platzlimit.",
    takenSpots: "Angemeldet",
    successTitle: "Du bist auf der Liste!",
    successText: "Wir benachrichtigen dich, wenn AgentCloud bereit ist.",
    fullTitle: "Warteliste geschlossen",
    fullText: "Die Plattform ist live: melde dich an oder erstelle ein Konto.",
    ...
    heroTitleA: "KI-Agenten, die arbeiten",
    heroTitleB: "für dein Business.",
    heroSub:
      "Erstelle KI-Agenten, die Kunden antworten, E-Mails verwalten und Workflows automatisieren, während du schläfst. Kein Code.",
    ...
    demoWelcome: "Hallo! Ich bin AgentCloud. Frag mich, wie du Support, Vertrieb oder Workflows automatisierst.",
    demoSuggestions: [
      "Wie automatisiere ich meinen Shopify?",
      "Zeig mir Order- & Warenkorb-Sync",
      "Wie handhabt ihr WhatsApp-Antworten?",
      "Was kann ein Agent für Leads tun?",
    ],
    ...
    navJoin: "Warteliste beitreten",
    navJoinShort: "Beitreten",
    demoTyping: "AgentCloud schreibt…",
    modalClose: "Schließen",
    piattaformaBadge: "Die Plattform",
    piattaformaTitle: "Automatisieren ohne Code",
    piattaformaSub: "AgentCloud ist ein Marktplatz für autonome KI-Agenten: auswählen, Tools verbinden und sie für dich arbeiten lassen — 24/7, auf WhatsApp, E-Mail, Shopify und mehr.",
    piattaformaF1Title: "Autonome Agenten",
    piattaformaF1Desc: "Jeder Agent hat ein klares Ziel: verkaufen, antworten, buchen, Abrechnungen erstellen. Sie entscheiden und handeln selbst.",
    piattaformaF2Title: "Mit deinen Tools integriert",
    piattaformaF2Desc: "Shopify, Gmail, Calendar, Sheets, Slack, Notion, HubSpot — in 2 Minuten verbunden.",
    piattaformaF3Title: "Ohne Code, sicher",
    piattaformaF3Desc: "Geführtes Setup, verschlüsselte Tokens, DSGVO-ready. Keine Daten für Training.",
    agentiBadge: "Agenten in Aktion",
    agentiTitle: "Wähle den Agenten, er erledigt den Rest",
    agentiCta: "Auf die Liste",
    heroDateLabel: "Ende • Offizieller Launch",
    heroDateDetails: "16:00 Uhr",
    heroDateNote: "Gleiches Datum wie der {launchat}-Proxy und der Countdown unten — kein anderes Datum.",
    chiSiamoBadge: "Über uns",
    chiSiamoTitle: "Drei Personen, eine Plattform",
    chiSiamoSub: "Wir bauen AgentCloud mit klaren Rollen und ohne Schnickschnack: solides Produkt, klare Kommunikation, geordnete Bücher.",
    foundersGabBio: "Entwickelt die Plattform, die Agenten und die Integrationen. Full-Stack, besessen von Tempo, Details und DX.",
    foundersAlleBio: "Erzählt AgentCloud auf Social Media und im Marketing. Macht aus Komplexität einfache Geschichten und funktionierende Kampagnen.",
    foundersMatteoBio: "Verwaltet Zahlungen, Pläne und Preise über Stripe. Hält die Bücher sauber und das Kauferlebnis flüssig.",
    teamPhotosNote: "Echte Teamfotos — keine Platzhalter. Kontaktiere uns unter",
    teamPhotosLink: "Über uns",
    integrazioniBadge: "Integrationen",
    integrazioniTitle: "Verbunden mit dem, was du schon nutzt",
    integrazioniSub: "In 2 Minuten verbunden, verschlüsselte Tokens, 1-Klick-Trennung.",
    integrazioniCta: "Warteliste beitreten →",
    integrazioniMore: "Und mehr in Vorbereitung: WhatsApp, WooCommerce, PayPal, Stripe, TikTok, Analytics…",
    customBadge: "Maßgeschneiderte Agenten",
    customTitle: "Dein Workflow ist einzigartig. Dein Agent auch.",
    customSub: "Erzähl uns deine Idee in 2 Minuten. Wir verbinden deine Tools und liefern einen fertigen Agenten in 3-7 Tagen — ohne Code, nur Ergebnisse.",
    customB1Title: "Maßgeschneidertes Design",
    customB1Desc: "Wir analysieren deinen Prozess und gestalten den Agenten, der die Sprache deines Unternehmens spricht.",
    customB2Title: "Echte Integrationen",
    customB2Desc: "Wir verbinden Shopify, Gmail, Slack, Stripe, Sheets und die anderen Tools, die du täglich nutzt.",
    customB3Title: "Schnelle Lieferung",
    customB3Desc: "Erhalte den Agenten konfiguriert, getestet und bereits in deinem Dashboard. Starthilfe inklusive.",
    customFormTitle: "Erzähl uns deine Idee",
    customFormHint: "2 Minuten, keine Verpflichtung. Wir antworten innerhalb von 24 Stunden mit einem klaren Vorschlag.",
    customIdeaPh: "Z. B. ein Agent, der E-Mails liest, Angebote erstellt und versendet...",
    customIntegrationsPh: "Shopify, Gmail, Slack...",
    customBudgetPh: "Z. B. €500-1500",
    customCta: "Fordere deinen Agenten an",
    customNote: "Keine Verpflichtung — erhalte Vorschlag und Angebot ohne Obligation.",
    socialPreviewBadge: "Verfügbare Agenten in Vorschau • Countdown aktiv",
    agentPreviewNote: "In Vorschau verfügbar",
    rankTitle: "Deine Position im Ranking",
    rankPointsText: "{points} Punkte insgesamt — {referrals} durch Referrals (3×{count}) + {instagram} durch Instagram",
    rankShareHint: "Teile deinen Link, um aufzusteigen — jeder Freund bringt dich weiter nach oben.",
    rankPointsLabel: "Gesamtpunkte",
    rankGenerating: "Wird generiert...",
    rankAheadTitle: "Die 5 vor dir",
    rankAheadRow: "vor dir",
    rankTopNote: "Du bist unter den Ersten! Niemand vor dir — lade Freunde ein, um vorne zu bleiben.",
    welcomeNote: "Du kannst es überspringen — du kannst es später in deinem Profil ergänzen.",
    welcomeThanks: "Danke!",
    welcomeThanksName: "Danke, {name}!",
   },
...
export const fr: Dictionary = {
  ...
  chat: {
    ...
    launchingDate: "Bientôt disponible",
  ...
  waitlist: {
    limitedAccess: "Accès anticipé",
    title: "Rejoins la",
    titleAccent: "liste d'attente",
    subtitle:
      "Sois parmi les premiers à essayer l'automatisation par IA. Inscriptions ouvertes, sans limite de places.",
    takenSpots: "Inscrits",
    successTitle: "Tu es sur la liste !",
    successText: "Nous te préviendrons quand AgentCloud sera prêt.",
    fullTitle: "Liste d'attente fermée",
    fullText: "La plateforme est en ligne : connecte-toi ou crée un compte.",
    ...
    heroTitleA: "Des agents IA qui travaillent",
    heroTitleB: "pour ton entreprise.",
    heroSub:
      "Crée des agents IA qui répondent aux clients, gèrent les emails et automatisent les workflows pendant que tu dors. Sans code.",
    ...
    demoWelcome: "Salut ! Je suis AgentCloud. Demande-moi comment automatiser support, ventes ou workflows.",
    demoSuggestions: [
      "Comment automatiser ma boutique Shopify ?",
      "Montre-moi la synchro commandes & panier",
      "Comment gérez-vous les réponses WhatsApp ?",
      "Que peut faire un agent pour les leads ?",
    ],
    ...
    navJoin: "Rejoindre la liste d'attente",
    navJoinShort: "Rejoindre",
    demoTyping: "AgentCloud écrit…",
    modalClose: "Fermer",
    piattaformaBadge: "La plateforme",
    piattaformaTitle: "Automatise sans écrire de code",
    piattaformaSub: "AgentCloud est un marketplace d'agents IA autonomes : choisis, connecte tes outils et laisse-les travailler pour toi — 24/7, sur WhatsApp, Email, Shopify et plus.",
    piattaformaF1Title: "Agents autonomes",
    piattaformaF1Desc: "Chaque agent a un objectif clair : vendre, répondre, réserver, facturer. Ils décident et agissent seuls.",
    piattaformaF2Title: "Intégré à tes outils",
    piattaformaF2Desc: "Shopify, Gmail, Calendar, Sheets, Slack, Notion, HubSpot — connexion en 2 minutes.",
    piattaformaF3Title: "Sans code, sécurisé",
    piattaformaF3Desc: "Configuration guidée, tokens chiffrés, conforme RGPD. Aucune donnée pour l'entraînement.",
    agentiBadge: "Agents en action",
    agentiTitle: "Choisis l'agent, il fait le reste",
    agentiCta: "Rejoindre la liste",
    heroDateLabel: "Échéance • Lancement officiel",
    heroDateDetails: "16h00",
    heroDateNote: "Même date que le proxy {launchat} et le compte à rebours ci-dessous — aucune autre date.",
    chiSiamoBadge: "Qui sommes-nous",
    chiSiamoTitle: "Trois personnes, une plateforme",
    chiSiamoSub: "Nous construisons AgentCloud avec des rôles clairs et zéro superflu : produit solide, communication claire, comptes en ordre.",
    foundersGabBio: "Développe la plateforme, les agents et les intégrations. Full-stack, obsédé par la vitesse, les détails et la DX.",
    foundersAlleBio: "Raconte AgentCloud sur les réseaux et en marketing. Traduit la complexité en histoires simples et en campagnes qui fonctionnent.",
    foundersMatteoBio: "Gère les paiements, les plans et les prix via Stripe. Garde les comptes en ordre et l'expérience d'achat fluide.",
    teamPhotosNote: "Vraies photos de l'équipe — pas de placeholders. Contacte-nous sur",
    teamPhotosLink: "Qui sommes-nous",
    integrazioniBadge: "Intégrations",
    integrazioniTitle: "Connecté à ce que tu utilises déjà",
    integrazioniSub: "Connexion en 2 minutes, tokens chiffrés, déconnexion en 1 clic.",
    integrazioniCta: "Rejoindre la liste d'attente →",
    integrazioniMore: "Et d'autres en approche : WhatsApp, WooCommerce, PayPal, Stripe, TikTok, Analytics…",
    customBadge: "Agents sur mesure",
    customTitle: "Ton workflow est unique. Ton agent aussi.",
    customSub: "Raconte-nous ton idée en 2 minutes. Nous connectons tes outils et livrons un agent prêt en 3-7 jours — sans code, juste des résultats.",
    customB1Title: "Conception sur mesure",
    customB1Desc: "Nous analysons ton processus et concevons l'agent qui parle le langage de ton entreprise.",
    customB2Title: "Intégrations réelles",
    customB2Desc: "Nous connectons Shopify, Gmail, Slack, Stripe, Sheets et les autres outils que tu utilises au quotidien.",
    customB3Title: "Livraison rapide",
    customB3Desc: "Reçois l'agent configuré, testé et déjà dans ton dashboard. Assistance au lancement incluse.",
    customFormTitle: "Raconte-nous ton idée",
    customFormHint: "2 minutes, sans engagement. Nous répondons sous 24 heures avec une proposition claire.",
    customIdeaPh: "Ex. un agent qui lit les emails, crée des devis et les envoie...",
    customIntegrationsPh: "Shopify, Gmail, Slack...",
    customBudgetPh: "Ex. €500-1500",
    customCta: "Demande ton agent",
    customNote: "Sans engagement — reçois proposition et devis sans obligation.",
    socialPreviewBadge: "Agents disponibles en aperçu • compte à rebours actif",
    agentPreviewNote: "Disponible en aperçu",
    rankTitle: "Ta position au classement",
    rankPointsText: "{points} points au total — {referrals} par parrainage (3×{count}) + {instagram} par Instagram",
    rankShareHint: "Partage ton lien pour grimper — chaque ami te fait monter.",
    rankPointsLabel: "Points totaux",
    rankGenerating: "Génération en cours...",
    rankAheadTitle: "Les 5 devant toi",
    rankAheadRow: "devant toi",
    rankTopNote: "Tu fais partie des premiers ! Personne devant toi — invite des amis pour rester en tête.",
    welcomeNote: "Tu peux passer — tu pourras l'ajouter plus tard depuis ton profil.",
    welcomeThanks: "Merci !",
    welcomeThanksName: "Merci, {name} !",
   },
